...
export class ContextProxy {
	...
	public setValue<K extends ZentaraCodeSettingsKey>(key: K, value: ZentaraCodeSettings[K]) {
	...
	public getValue<K extends ZentaraCodeSettingsKey>(key: K): ZentaraCodeSettings[K] {
		return isSecretStateKey(key)
			? (this.getSecret(key) as ZentaraCodeSettings[K])
			: (this.getGlobalState(key) as ZentaraCodeSettings[K])
	}
