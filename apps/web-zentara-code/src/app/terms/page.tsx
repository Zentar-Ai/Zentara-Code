			...
			<div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					...
					<p className="lead">
						...
						Zentara Code Cloud service (the &quot;<strong>Service</strong>&quot;). They apply to:
					</p>
					<ul className="lead">
						<li>
						...
						<table className="min-w-full border-collapse border border-border">
							...
							<tbody>
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Zentara Code <strong>does not</strong> use Customer Content to train, fine-tune,
					...
					<p>
						...
						) explains how Zentara Code collects and handles personal information. If Customer requires a
						DPA, email{" "}
					...
					<ol>
						<li>
							...
							<br />
							Customer may not assign the Agreement without Zentara Code&apos;s prior written consent,
						...
						<li>
							...
							<br />
							Zentara Code may update these TOS by posting a revised version at the same URL and emailing
