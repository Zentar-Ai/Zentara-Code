				...
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					...
					<ul className="lead">
						...
						<li>
							...
							<strong>app.zentaracode.com</strong> or through the Zentara Code extension while
					...
					<div className="my-8 rounded-lg border border-border bg-muted/50 p-6">
						...
						<p className="mb-0">
							If you run the Zentara Code extension <strong>without</strong> connecting to a Cloud
					...
					<ul>
						<li>
							<strong>Your source code never transits Zentara Code servers.</strong> It stays on your
							device and is sent <strong>directly</strong>—via a client‑to‑provider TLS connection—to the
							third‑party AI model you select. Zentara Code never stores, inspects, or trains on your
							code.
						</li>
						<li>
							<strong>Prompts and chat snippets are collected by default</strong> in Zentara Code Cloud so
