						...
						<div className="relative mt-8 flex items-center justify-center lg:mt-0">
							...
							<div className="relative z-10 rounded-lg border border-border bg-card p-6 shadow-lg">
								...
								<p className="mb-4 text-sm text-muted-foreground">
									A unified control system for managing Zentara Code across your organization, with
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					<div className="mb-12 text-center">
						...
						<p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
							Zentara Code Cloud provides enterprise-grade control and visibility for Zentara Code
					...
					<div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
						...
						<div className="rounded-lg border border-border bg-card p-6 shadow-sm transition-all hover:shadow-md">
							...
							<p className="text-muted-foreground">
								Manage Zentara Code deployments enterprise-wide, with an extensible platform ready for
						...
						<div className="rounded-lg border border-border bg-card p-6 shadow-sm transition-all hover:shadow-md">
							...
							<p className="text-muted-foreground">
								Implement security policies for Zentara Code that align with your enterprise AI
						...
						<div className="rounded-lg border border-border bg-card p-6 shadow-sm transition-all hover:shadow-md">
							...
							<p className="text-muted-foreground">
								Deploy your Zentara Code control-plane instantly with our SaaS solution. No
						...
						<div className="rounded-lg border border-border bg-card p-6 shadow-sm transition-all hover:shadow-md">
							...
							<p className="text-muted-foreground">
								Developers get seamless Zentara Code access while you maintain governance and
								visibility.
							</p>
							<ul className="mt-4 space-y-2">
								<li className="flex items-start">
