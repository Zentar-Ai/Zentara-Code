...
export const metadata: Metadata = {
	title: "Terms of Service - Zentara Code",
	description:
		"Terms of Service for Zentara Code Cloud. Learn about our service terms, commercial conditions, and legal framework.",
}
			...
			<div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					<h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
						Zentara Code Cloud Terms of Service
					</h1>
					...
					<p className="lead">
						These Terms of Service (&quot;<strong>TOS</strong>&quot;) govern access to and use of the Zentara
					...
					<ul className="lead">
						<li>
							...
							executed by Zentara Code and the customer that references these TOS; <strong>and</strong>
						</li>
						<li>
							<strong>(b)</strong> any{" "}
					...
					<p>
						If Zentara Code and Customer later execute a Master Subscription Agreement (&quot;
						...
						<table className="min-w-full border-collapse border border-border">
							...
							<tbody>
								...
								<tr className="bg-muted/25">
									...
									<td className="border border-border px-4 py-2">
										Zentara Code maintains commercially reasonable administrative, physical, and
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Zentara Code <strong>does not</strong> use Customer Content to train, fine-tune, or
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Zentara Code may identify Customer (name & logo) in marketing materials unless
					...
					<ol>
						...
						<li>
							...
							<br />
							Deleted – Zentara Code offers no trials, pilots, betas, or SLA credits under these TOS.
						</li>
						<li>
					...
					<p>
						Zentara Code&apos;s Privacy Notice (
						<a
							href="https://zentaracode.com/privacy"
							rel="noopener noreferrer"
							className="text-primary hover:underline">
							https://zentaracode.com/privacy
						</a>
						) explains how Zentara Code collects and handles personal information. If Customer requires a DPA,
						email{" "}
						<a href="mailto:support@zentaracode.com" className="text-primary hover:underline">
							support@zentaracode.com
						</a>
						.
					</p>
					...
					<ol>
						<li>
							...
							<br />
							Customer may not assign the Agreement without Zentara Code&apos;s prior written consent, except
						...
						<li>
							...
							<br />
							Zentara Code may update these TOS by posting a revised version at the same URL and emailing or
					...
					<p>
						<strong>Zentara Code, Inc.</strong>
						<br />
