...
export interface RooCodeAPI {
	...
	listeners<K extends keyof RooCodeEvents>(eventName: K): Function[];
	rawListeners<K extends keyof RooCodeEvents>(eventName: K): Function[];
	emit<K extends keyof RooCodeEvents>(eventName: K, ...args: RooCodeEvents[K]): boolean;
	listenerCount(eventName: keyof RooCodeEvents, listener?: Function): number;
	prependListener<K extends keyof RooCodeEvents>(eventName: K, listener: (...args: RooCodeEvents[K]) => void): this;
	prependOnceListener<K extends keyof RooCodeEvents>(eventName: K, listener: (...args: RooCodeEvents[K]) => void): this;
