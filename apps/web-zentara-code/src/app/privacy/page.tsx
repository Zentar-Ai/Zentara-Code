...
export const metadata: Metadata = {
	title: "Privacy Policy - Zentara Code",
	description:
		"Privacy policy for Zentara Code Cloud and marketing website. Learn how we handle your data and protect your privacy.",
}
			...
			<div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					<h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
						Zentara Code Cloud Privacy Policy
					</h1>
					<p className="text-muted-foreground">Last Updated: June 19, 2025</p>

					<p className="lead">
						This Privacy Policy explains how Zentara Code, Inc. (&quot;Zentara Code,&quot; &quot;we,&quot;
						&quot;our,&quot; or &quot;us&quot;) collects, uses, and shares information when you:
					</p>
					<ul className="lead">
						<li>
							browse any page under <strong>zentaracode.com</strong> (the <em>Marketing Site</em>); and/or
						</li>
						<li>
							create an account for, sign in to, or otherwise use <strong>Zentara Code Cloud</strong> at{" "}
							<strong>app.zentaracode.com</strong> or through the Zentara Code extension while authenticated to
					...
					<div className="my-8 rounded-lg border border-border bg-muted/50 p-6">
						...
						<p className="mb-0">
							If you run the Zentara Code extension <strong>without</strong> connecting to a Cloud account,
					...
					<ul>
						<li>
							<strong>Your source code never transits Zentara Code servers.</strong> It stays on your device
							and is sent <strong>directly</strong>—via a client‑to‑provider TLS connection—to the
							third‑party AI model you select. Zentara Code never stores, inspects, or trains on your code.
						</li>
						<li>
							<strong>Prompts and chat snippets are collected by default</strong> in Zentara Code Cloud so you
							can search and re‑use past conversations. Organization admins can disable this collection at
							any time.
						</li>
						<li>
							We collect only the data needed to operate Zentara Code Cloud, do <strong>not</strong> sell
					...
					<ul>
						<li>
							<strong>Operate & secure Zentara Code Cloud</strong> (authentication, completions, abuse
							prevention)
						</li>
						<li>
						...
						<table className="min-w-full border-collapse border border-border">
							...
							<tbody>
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Zentara Code servers; ad networks; model‑training pipelines
									</td>
								</tr>
								<tr className="bg-muted/25">
									<td className="border border-border px-4 py-2 font-medium">
									...
									<td className="border border-border px-4 py-2">
										Zentara Code Cloud (encrypted at rest)
									</td>
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Zentara Code servers (we store only the Stripe customer ID)
									</td>
								</tr>
							</tbody>
						</table>
					...
					<ul>
						<li>
							<strong>Source Code:</strong> Never stored on Zentara Code servers.
						</li>
						<li>
					...
					<ul>
						...
						<li>
							...
							<strong>Security Settings</strong> inside Zentara Code Cloud.
						</li>
					</ul>
